...
import { gridData as data, testData } from "@app/assets/mockdata/gridMockData";
...
import MyTeamPopUp from "@app/components/EditPopUp/MyTeamPopUp";
...
function MyTeam() {
  ...
  // const onEdit = ()=> navigateTo('/')
  const listContainerProps = {
    containerName: "List Of Admins",
    isLegend: true,
    isSelect: true,
    isViewBy: true,
    isSearch: true,
